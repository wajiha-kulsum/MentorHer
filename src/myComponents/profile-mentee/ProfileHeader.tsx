    ...
    <div className="relative mb-12">
      ...
      <div className="bg-card rounded-2xl shadow-lg p-6 pb-4 mx-4 -mt-16 border-2 border-background relative z-10">
        ...
        <div className="mt-20">
          ...
          {headline && (
            <p className="text-muted-foreground mt-2 text-lg font-light leading-relaxed">{headline}</p>
          )}
          ...
          <div className="flex gap-3 mt-6">
            ...
            {isOwnProfile && (
              <Button variant="outline" className="rounded-full px-6">View as others</Button>
            )}
          </div>
        </div>
      </div>
